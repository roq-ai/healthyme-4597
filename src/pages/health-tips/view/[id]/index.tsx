...
import { getHealthTipById } from 'apiSdk/health-tips';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Health Tip Detail View
          </Text>
          {hasAccess('health_tip', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/health-tips/edit/${data?.id}`} passHref legacyBehavior>
              <Button
