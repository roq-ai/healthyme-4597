            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('community', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>community</Th>}
                  {hasAccess('diet_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>diet_plan</Th>}
                  {hasAccess('health_tip', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>health_tip</Th>}
